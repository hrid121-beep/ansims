...
namespace IMS.Application.DTOs
{
    ...
    public class ItemDto : BaseDto
    {
        ...
        public string CatalogueLedgerNo { get; set; }  // লেজার নং
        public string CataloguePageNo { get; set; }    // পাতা নং
        public DateTime? CatalogueEntryDate { get; set; }
        public DateTime? FirstReceivedDate { get; set; }
        public string CatalogueRemarks { get; set; }
    }
    ...
    public class ReceiveItemDto : BaseDto
    {
        ...
        public string ItemCode { get; set; }
        public string ItemName { get; set; }
        public string ImagePath { get; set; }  // Item image
        public string CategoryName { get; set; }
        public string StoreName { get; set; }
        public string Unit { get; set; }
        public List<string> DamagePhotos { get; set; } = new List<string>();
    ...
    public class BarcodeDto : BaseDto
    {
        ...
        public string GeneratedBy { get; set; }
        public string GeneratedByName { get; set; } // User display name
    ...
    public class RangeDto
    {
        ...
        public DateTime CreatedAt { get; set; }
        public string CreatedBy { get; set; }
        public string CreatedByName { get; set; } // User display name
        public DateTime? UpdatedAt { get; set; }
        public string UpdatedBy { get; set; }
        public string UpdatedByName { get; set; } // User display name
    }
    ...
    // ========== Central Store Register Report DTOs (কেন্দ্রীয় ভান্ডার মজুদ তালিকা) ==========
    public class CentralStoreRegisterDto
    {
        public DateTime ReportDate { get; set; } = DateTime.Now;
        public string ReportTitle { get; set; } = "কেন্দ্রীয় আনসার ভান্ডারের মজুদ উপকরণের তালিকা";
        public string CategoryName { get; set; } // e.g., "পোশাক ও পোশাক সামগ্রী"
        public string CategoryNameBn { get; set; }
        public int? StoreId { get; set; }
        public string StoreName { get; set; }
        public string StoreNameBn { get; set; }
        public List<CentralStoreRegisterItemDto> Items { get; set; } = new List<CentralStoreRegisterItemDto>();
    ...
    public class CentralStoreRegisterItemDto
    {
        public int SerialNo { get; set; } // ক্রম
        public string LedgerNo { get; set; } // লেজার নং (e.g., "01", "02")
        public string PageNo { get; set; } // পাতা নং (e.g., "29", "94")
        public string ItemName { get; set; } // উপকরণের নাম (English)
        public string ItemNameBn { get; set; } // উপকরণের নাম (Bengali)
        public string Unit { get; set; } // হিসাবের একক
        public decimal TotalQuantity { get; set; } // কেন্দ্রীয় ভান্ডারে মোট পরিমাণ
        public decimal AllocatedQuantity { get; set; } // বিভিন্ন ইউনিটে বরাদ্দকৃত
        public decimal RemainingQuantity { get; set; } // অবশিষ্ট উপকরণ
        public DateTime? ReceivedDate { get; set; } // কেন্দ্রীয় ভান্ডারে গ্রহণের তারিখ
        public string SupplierName { get; set; } // সরবরাহকারী প্রতিষ্ঠান
